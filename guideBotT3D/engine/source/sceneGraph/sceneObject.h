...
//.logicking guideBot >>
namespace GuideBot { class WorldObject; }
//.logicking guideBot <<
...
class SceneObject : public NetObject, private SceneContainer::Link, public ProcessObject
{
   ...
   public:
      ...
      //.logicking guidebot >>
      GuideBot::WorldObject*	getWorldObject() {return m_worldObject;};
      //.logicking guidebot <<
   ...
   //.logicking guidebot >>
   protected:
   //representation for guide bot system
   virtual void createWorldObject() {};
   virtual void destroyWorldObject() {};
   GuideBot::WorldObject*	m_worldObject;
   //.logicking guidebot <<
